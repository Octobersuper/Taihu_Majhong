package com.zcf.mahjong.backservlet;
...
public class BackUserServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         * 开启规则玩法
         */
        if ("onthirteen".equals(type)) { // 操作用户
            returnMap.put("state", backUserDao.onThirteen(Integer.parseInt(request.getParameter("backuserids")),
                    Integer.parseInt(request.getParameter("backuserid"))));
        }
         ...
         * 关闭规则玩法
         */
        if ("offthirteen".equals(type)) { // 操作用户
            returnMap.put("state", backUserDao.offThirteen(Integer.parseInt(request.getParameter("backuserids")),
                    Integer.parseInt(request.getParameter("backuserid"))));
        }/**
         * 开启查看活动
         */
        if ("onfourteen".equals(type)) { // 操作用户
            returnMap.put("state", backUserDao.onFourteen(Integer.parseInt(request.getParameter("backuserids")),
                    Integer.parseInt(request.getParameter("backuserid"))));
        }
        /**
         * 关闭查看活动
         */
        if ("offfourteen".equals(type)) { // 操作用户
            returnMap.put("state", backUserDao.offFourteen(Integer.parseInt(request.getParameter("backuserids")),
                    Integer.parseInt(request.getParameter("backuserid"))));
        }/**
         * 开启招募代理
         */
        if ("onfifteen".equals(type)) { // 操作用户
            returnMap.put("state", backUserDao.onFifteen(Integer.parseInt(request.getParameter("backuserids")),
                    Integer.parseInt(request.getParameter("backuserid"))));
        }
         ...
         * 关闭招募代理
         */
        if ("offfifteen".equals(type)) { // 操作用户
            returnMap.put("state", backUserDao.offFifteen(Integer.parseInt(request.getParameter("backuserids")),
                    Integer.parseInt(request.getParameter("backuserid"))));
        }
		...
		// 规则管理
		if ("getgui".equals(type)) {
			returnMap.put("list", backUserDao.getgui(request.getParameter("backuserid")));
		}

		// 修改游戏规则
		if ("updgui".equals(type)) {
			returnMap.put("state", backUserDao.updgui(request.getParameter("value"),
					Integer.parseInt(request.getParameter("introduceid"))));
		}
		...
		// 修改活动介绍
		if ("updateActivity".equals(type)) {
			returnMap.put("status", backUserDao.updateActivity(Integer.parseInt(request.getParameter("activityid")),
					request.getParameter("value")));
		}
		//查看招募代理
		if("getAgency".equals(type)){
			returnMap.put("list", backUserDao.getAgency(request.getParameter("backuserid")));
		}

		// 修改招募代理
		if ("updateAgency".equals(type)) {
			returnMap.put("status", backUserDao.updateAgency(Integer.parseInt(request.getParameter("agencyid")),
					request.getParameter("value")));
		}
		...
		/*****************************作弊牌型*********************************/
		//查看作弊牌型
		if("getBrandsType".equals(type)){
			returnMap.put("list", backUserDao.getBrandsType(request.getParameter("backuserid")));
		}
		/************************** 后台管理列表 ****************************/
		...
		if ("selectBackUser".equals(type)) {
			returnMap.put("list", backUserDao.selectBackUser(request.getParameter("backuserid")));
		}
		// 删除后台用户
