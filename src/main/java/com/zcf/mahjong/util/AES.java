...
//    public static final String AES_TYPE = "AES/ECB/NoPadding";
    ...
    //私钥  
    private static final String AES_KEY="ae125efkk4454eef";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。  
    ...
    public static void test(String content) throws UnsupportedEncodingException{
        ...
        System.out.println();
       // encryptResult="lSnNx4cSyrap1zNnJnF5TS8iLz30bJ2/m9p+8v1BQ1A=";
        // 解密
